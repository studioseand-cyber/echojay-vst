#!/bin/bash
# Build + run the Link mixer geometry self-test against the real objects.
...
#
# It links the lib rather than recompiling PluginEditor.cpp so the test
