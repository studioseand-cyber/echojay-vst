...
struct Probe
{
    ...
    */
    using Route = ejmap::route::Route;
    using Floor = ejmap::route::Floor;
    static constexpr auto routeVerdict = &ejmap::route::routeVerdict;
    static constexpr auto routeText   = &ejmap::route::routeText;
